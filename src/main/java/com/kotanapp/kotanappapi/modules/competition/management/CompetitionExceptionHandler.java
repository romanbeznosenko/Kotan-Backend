...
public class CompetitionExceptionHandler {
    ...
    @ApiResponses(value = {
            @ApiResponse(
                    responseCode = "404", description = "Competition not found in the system.",
                    content = @Content(
                            examples = @ExampleObject(value = """
                                      {
                                      "data": null,
                                      "message": "Competition not found in the system.",
    ...
    public ResponseEntity<CustomResponse<String>> handleCompetitionNotFoundException(CompetitionNotFoundException ex) {
