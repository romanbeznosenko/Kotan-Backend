...
public class NewsExceptionHandler {
    ...
    @ApiResponses(value = {
            @ApiResponse(
                    responseCode = "404", description = "News not found in the system.",
                    content = @Content(
                            examples = @ExampleObject(value = """
                                      {
                                      "data": null,
                                      "message": "News not found in the system.",
    ...
    public ResponseEntity<CustomResponse<String>> handleNewsNotFound(NewsNotFoundException ex) {
