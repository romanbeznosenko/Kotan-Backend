...
public class PlayerExceptionHandler {
    ...
    @ApiResponses(value = {
            @ApiResponse(
                    responseCode = "404", description = "Player not found in the system.",
                    content = @Content(
    ...
    public ResponseEntity<CustomResponse<String>> handlePlayerNotFound(PlayerNotFoundException ex) {
